...
|   CREATE TABLE "TEMPERATURE_TABLE" 
   (	"IDENT" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"TEMPID" NUMBER, 
	"TEMP" NUMBER, 
	"INRANGE" NUMBER, 
	"TIMESTAMPTEMP" TIMESTAMP (6) WITH TIME ZONE, 
	 CONSTRAINT "TEMPERATURE_TABLE_PK" PRIMARY KEY ("IDENT")
  USING INDEX  ENABLE
   ) ;| *Temperature* |  |
| | *FishCounter* | |
|  | *FishDescription* |  |
